...
//			}], 
	    ...
	    tooltip: {
		   formatter: function() {
    		 ...
    		 /* tip += "换手率："+hsl+"<br/>";*/
    		  $reporting.html(
    				  '  <span style="font-weight:bold;font-size: 24px">'+stockName+'</span>'
    				+ ' <br/><span style="padding-left:25px" >开盘：</span>'+ open
    				+'  <span style="padding-left:25px">收盘：</span>'+close
              		+'  <span style="padding-left:25px">最高：</span>'+ high
              		+'  <span style="padding-left:25px">最低：</span>'+ low
