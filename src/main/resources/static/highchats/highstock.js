...
(function () {
    ...
    function Ia(a, b, c, d) {
        var e = F.lang, a = +a || 0, f = b === -1 ? (a.toString().split(".")[1] || "").length : isNaN(b = M(b)) ? 2 : b,
            b = c === void 0 ? e.decimalPoint : c, d = d === void 0 ? e.thousandsSep : d, e = a < 0 ? "-" : "",
            c = String(I(a = M(a).toFixed(f))), g = c.length > 3 ? c.length % 3 : 0;
    ...
    var r, B = document, X = window, V = Math, s = V.round, S = V.floor, Va = V.ceil, w = V.max, z = V.min, M = V.abs,
        da = V.cos, ia = V.sin, ra = V.PI, Ma = ra * 2 / 360, Da = navigator.userAgent, Sb = X.opera,
        Ha = /msie/i.test(Da) && !Sb, lb = B.documentMode === 8, mb = /AppleWebKit/.test(Da),
        $a = /Firefox/.test(Da), cb = /(Mobile|Android|Windows Phone)/.test(Da), Ea = "http://www.w3.org/2000/svg",
        ca = !!B.createElementNS && !!B.createElementNS(Ea, "svg").createSVGRect,
        Yb = $a && parseInt(Da.split("Firefox/")[1], 10) < 4, ja = !ca && !Ha && !!B.createElement("canvas").getContext,
        Wa, ab, Tb = {}, Ab = 0, hb, F, ua, Ca, Bb, H, na = function () {
        }, aa = [], db = 0, Ta = "div", Y = "none", Zb = /^[0-9]+$/, $b = "stroke-width", ib, La, ub, vb, wb, Ua, jb, kb,
        Nb, Ob, xb, Pb, Qb, C = {}, P = X.Highcharts = X.Highcharts ? qa(16, !0) : {};
    ua = function (a, b, c) {
        if (!t(b) || isNaN(b))return "Invalid date";
        var a = o(a, "%Y-%m-%d %H:%M:%S"), d = new Date(b - La), e, f = d[vb](), g = d[wb](), h = d[Ua](), i = d[jb](),
            k = d[kb](), j = F.lang, l = j.weekdays, d = v({
                a: l[g].substr(0, 3),
                A: l[g],
                d: Qa(h),
                e: h,
    ...
    J && J.init.call(J, Bb);
    var nb = Q.adapterRun, ac = Q.getScript, wa = Q.inArray, q = Q.each, Cb = Q.grep, bc = Q.offset, xa = Q.map,
        A = Q.addEvent, R = Q.removeEvent, N = Q.fireEvent, cc = Q.washMouseEvent, ob = Q.animate, eb = Q.stop, Q = {
    ...
    var dc = /rgba\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]?(?:\.[0-9]+)?)\s*\)/,
        ...
        fc = /rgb\(\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*,\s*([0-9]{1,3})\s*\)/, Fa = function (a) {
            var b = [], c, d;
            (function (a) {
    ...
    ka.prototype = {
        ...
        destroy: function () {
            ...
            for (var b = a.element, c = this, d = c.forExport, e = o(a.textStr, "").toString(),
                     f = e.indexOf("<") !== -1, g = b.childNodes, h, i, k = W(b, "x"), j = a.styles, l = a.textWidth,
                ...
                q(g, function (e) {
                    if (e !== "" || g.length === 1) {
                        ...
                        if (e !== " ") {
                            ...
                            b.appendChild(u);
                            m++;
                            if (l)for (var e = e.replace(/([^\^])-/g, "$1- ").split(" "),
                                           n = e.length > 1 && j.whiteSpace !== "nowrap", q, r, D = a._clipHeight,
                                           t = [], s = p(),
                                           w = 1; n && (e.length || t.length);)delete a.bBox, q = a.getBBox(), r = q.width, !ca && c.forExport && (r = c.measureSpanWidth(u.firstChild.data, a.styles)), q = r > l, !q || e.length === 1 ? (e = t, t = [], e.length && (w++,
            ...
            var k = this.label(a, b, c, i, null, null, null, null, "button"), j = 0, l, m, n, p, u, o,
                a = {x1: 0, y1: 0, x2: 0, y2: 1}, e = y({
                    "stroke-width": 1,
                    stroke: "#CCCCCC",
            ...
            var e = fa(a) ? a.r : e, g = this.createElement("rect"),
                a = fa(a) ? a : a === r ? {} : {x: a, y: b, width: w(c, 0), height: w(d, 0)};
            ...
            circle: function (a, b, c, d) {
                ...
                var f = z(e && e.r || 0, c, d), g = f + 6, h = e && e.anchorX, i = e && e.anchorY,
            ...
            var e = "highcharts-" + Ab++, f = this.createElement("clipPath").attr({id: e}).add(this.defs),
            ...
            var a = a || this.style.fontSize, a = /px/.test(a) ? I(a) : /em/.test(a) ? parseFloat(a) * 12 : 12,
                a = a < 24 ? a + 4 : s(a * 1.2), b = s(a * 0.8);
            return {h: a, b: b}
            ...
            var m = this, n = m.g(i), p = m.text("", 0, 0, g).attr({zIndex: 1}), u, o, G = 0, x = 3, w = 0, bb, Eb, Fb,
                Gb, Ub = 0, D = {}, U, z;
            n.onAdd = function () {
                p.add(n);
    ...
    if (!ca && !ja) P.VMLElement = ea = {
        ...
        getSpanCorrection: function (a, b, c, d, e) {
            ...
            for (var b = a.length,
                     c = []; b--;)if (la(a[b])) c[b] = s(a[b] * 10) - 5; else if (a[b] === "Z") c[b] = "x"; else if (c[b] = a[b], a.isArc && (a[b] === "wa" || a[b] === "at")) c[b + 5] ===
        ...
        clipRect: function (a, b, c, d) {
            ...
            return v(e, {
                ...
                getCSS: function (a) {
                    var b = a.element, c = b.nodeName, a = a.inverted, d = this.top - (c === "shape" ? b.offsetTop : 0),
                        ...
                        d = {clip: "rect(" + s(a ? e : d) + "px," + s(a ? f : b) + "px," + s(a ? b : f) + "px," + s(a ? d : e) + "px)"};
            ...
            if (i) {
                var j, l, m = a.linearGradient || a.radialGradient, n, p, u, o, G, x = "", a = a.stops, r, t = [],
                    s = function () {
    ...
    Za.prototype = {
        addLabel: function () {
            var a =
                ...
                h = b.labels, i = a.tickPositions,
                d = d && e && !h.step && !h.staggerLines && !h.rotation && c.plotWidth / i.length || !d && (c.margin[3] || c.chartWidth * 0.33),
                k = g === i[0], j = g === i[i.length - 1], l, f = e ? o(e[g], f[g], g) : g, e = this.label, m = i.info;
            ...
            var c = !0, d = this.axis, e = this.isFirst, f = this.isLast, g = d.horiz ? b.x : b.y, h = d.reversed,
                i = d.tickPositions, k = this.getLabelSides(), j = k[0], k = k[1], l, m, n, p = this.label.line || 0;
            l = d.labelEdge;
            ...
            var i =
                    this.axis, k = i.transA, j = i.reversed, l = i.staggerLines,
                m = i.chart.renderer.fontMetrics(e.style.fontSize).b, n = e.rotation,
                a = a + e.x - (f && d ? f * k * (j ? -1 : 1) : 0), b = b + e.y - (f && !d ? f * k * (j ? 1 : -1) : 0);
            ...
            var d = this.axis, e = d.options, f = d.chart.renderer, g = d.horiz, h = this.type,
                i = this.label, k = this.pos, j = e.labels, l = this.gridLine, m = h ? h + "Grid" : "grid",
                n = h ? h + "Tick" : "tick", p = e[m + "LineWidth"], u = e[m + "LineColor"], q = e[m + "LineDashStyle"],
                G = e[n + "Length"], m = e[n + "Width"] || 0, x = e[n + "Color"], t = e[n + "Position"], n = this.mark,
                s = j.step, w = !0, v = d.tickmarkOffset, y = this.getPosition(g, k, v, b), z = y.x, y = y.y,
    ...
    P.PlotLineOrBand.prototype = {
        render: function () {
            var a = this, b = a.axis, c = b.horiz, d = (b.pointRange || 0) / 2, e = a.options, f = e.label, g = a.label,
                h = e.width, i = e.to, k = e.from, j = t(k) && t(i), l = e.value, m = e.dashStyle, n = a.svgElem,
                p = [], u, q = e.color, G = e.zIndex, x = e.events,
    ...
    L.prototype = {
        ...
        defaultLabelFormatter: function () {
            var a = this.axis, b = this.value, c = a.categories, d = this.dateTimeLabelFormat,
                e = F.lang.numericSymbols, f = e && e.length, g, h = a.options.labels.format,
        ...
        translate: function (a, b, c, d, e, f) {
            var g = 1, h = 0, i = d ? this.oldTransA : this.transA, d = d ? this.oldMin : this.min,
                k = this.minPixelPadding, e = (this.options.ordinal || this.isLog &&
                    e) && this.lin2val;
            if (!i) i = this.transA;
            if (c) g *= -1, h = this.len;
        ...
        getPlotLinePath: function (a, b, c, d, e) {
            var f = this.chart, g = this.left,
                h = this.top, i, k, j = c && f.oldChartHeight || f.chartHeight,
        ...
        adjustForMinRange: function () {
            var a =
                    this.options, b = this.min, c = this.max, d, e = this.dataMax - this.dataMin >= this.minRange, f, g, h,
                i, k;
        ...
        setAxisTranslation: function (a) {
            var b = this, c = b.max - b.min, d = b.axisPointRange || 0, e, f = 0, g = 0, h = b.linkedParent,
                i = !!b.categories, k = b.transA;
            if (b.isXAxis || i || d) h ? (f = h.minPointOffset, g = h.pointRangePadding) : q(b.series, function (a) {
                var h = i ? 1 : b.isXAxis ? a.pointRange : b.axisPointRange || 0, k = a.options.pointPlacement,
        ...
        setTickPositions: function (a) {
            var b = this, c = b.chart, d = b.options, e = b.isLog, f = b.isDatetimeAxis, g = b.isXAxis, h = b.isLinked,
                i = b.options.tickPositioner, k = d.maxPadding, j = d.minPadding, l = d.tickInterval,
                m = d.minTickInterval, n = d.tickPixelInterval, p, u = b.categories;
        ...
        setAxisSize: function () {
            var a = this.chart, b = this.options, c = b.offsetLeft || 0, d = this.horiz,
                e = o(b.width, a.plotWidth - c + (b.offsetRight || 0)), f = o(b.height, a.plotHeight),
        ...
        getOffset: function () {
            var a = this, b = a.chart, c = b.renderer, d = a.options,
                e = a.tickPositions, f = a.ticks, g = a.horiz, h = a.side, i = b.inverted ? [1, 0, 3, 2][h] : h, k,
                j = 0, l, m = 0, n = d.title, p = d.labels, u = 0, Db = b.axisOffset, G = b.clipOffset,
                x = [-1, 1, 1, -1][h], s, v = 1, y = o(p.maxStaggerLines, 5), z, A, B, D,
        ...
        getTitlePosition: function () {
            var a = this.horiz, b = this.left, c = this.top, d = this.len, e = this.options.title, f = a ? b : c,
                g = this.opposite, h = this.offset, i = I(e.style.fontSize || 12),
        ...
        render: function () {
            var a = this,
                ...
                p = f.stackLabels, u = f.alternateGridColor, o = a.tickmarkOffset, G = f.lineWidth,
                x = d.hasRendered && t(a.oldMin) && !isNaN(a.oldMin), s = a.hasData, w = a.showAxis, v,
                y = f.labels.overflow, z = a.justifyLabels = b && y !== !1, A;
    ...
    L.prototype.getTimeTicks = function (a, b, c, d) {
        ...
        if (t(b)) {
            ...
            h = i[kb]();
            for (var d = i.getTime(), l = i[jb](), m = i[Ua](),
                     n = g ? La : (864E5 + i.getTimezoneOffset() * 6E4) % 864E5; d < c;)e.push(d), k === H.year ? d = ib(h + b * j, 0) : k === H.month ? d = ib(h, l + b * j) : !g && (k === H.day || k === H.week) ? d = ib(h, l, m + b * j * (k === H.day ?
                    1 : 7)) : d += k * j, b++;
            e.push(d);
            q(Cb(e, function (a) {
    ...
    L.prototype.getLogTickPositions = function (a, b, c, d) {
        ...
        if (a >= 0.5) a = s(a), g = this.getLinearTickPositions(a, b, c); else if (a >= 0.08)for (var f = S(b), h, i, k,
                                                                                                      j, l,
                                                                                                      e = a > 0.3 ? [1, 2, 4] : a > 0.15 ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < c + 1 && !l; f++) {
            i = e.length;
    ...
    Hb.prototype = {
        init: function (a, b) {
            ...
            var d = this.chart, e = this.distance, f = {}, g, h = ["y", d.chartHeight, b, c.plotY + d.plotTop],
                ...
                k = c.ttBelow || d.inverted && !c.negative || !d.inverted && c.negative, j = function (a, b, c, d) {
            ...
            var b = a.series, c = b.tooltipOptions, d = c.dateTimeLabelFormats, e = c.xDateFormat, f = b.xAxis,
                g = f && f.options.type === "datetime" && la(a.key), c = c.headerFormat, f = f && f.closestPointRange,
                h;
            if (g && !e) {
                if (f)for (h in H) {
    ...
    Xa.prototype = {
        init: function (a, b) {
            ...
            var b = this.chart, c = b.series, d = b.tooltip, e, f, g = b.hoverPoint, h = b.hoverSeries, i, k,
                j = b.chartWidth, l = this.getIndex(a);
            ...
            var b = this.chart, c = b.options.chart, d = a.chartX, e = a.chartY, f = this.zoomHor, g = this.zoomVert,
                h = b.plotLeft, i = b.plotTop, k = b.plotWidth, j = b.plotHeight, l, m = this.mouseDownX,
                n = this.mouseDownY;
            d < h ? d = h : d > h + k && (d = h + k);
            e < i ? e = i : e > i + j && (e = i + j);
            ...
            if (this.selectionMarker) {
                var d = {xAxis: [], yAxis: [], originalEvent: a.originalEvent || a}, a = this.selectionMarker,
                    e = a.attr ? a.attr("x") : a.x, f = a.attr ? a.attr("y") : a.y,
                    g = a.attr ? a.attr("width") : a.width, h = a.attr ? a.attr("height") : a.height, i;
    ...
    v(P.Pointer.prototype, {
        pinchTranslate: function (a, b, c, d, e, f) {
            ...
            var i = this.chart, k = a ? "x" : "y", j = a ? "X" : "Y", l = "chart" + j, m = a ? "width" : "height",
                n = i["plot" + (a ? "Left" : "Top")], p, u, o = h || 1, q = i.inverted, x = i.bounds[a ? "h" : "v"],
                r = b.length === 1, s = b[0][l], t = c[0][l], w = !r && b[1][l], v = !r && c[1][l], y, c = function () {
                    !r &&
            ...
            var b = this, c = b.chart, d = b.pinchDown, e = b.followTouchMove, f = a.touches, g = f.length,
                h = b.lastValidTouch, i = b.hasZoom, k = b.selectionMarker, j = {},
            ...
            if (a.type === "touchstart") q(f, function (a, b) {
                ...
                if (a.zoomEnabled) {
                    var b = c.bounds[a.horiz ? "h" : "v"], d = a.minPixelPadding, e = a.toPixels(a.dataMin),
                        f = a.toPixels(a.dataMax), g = z(e, f), e = w(e, f);
                    b.min = z(a.pos, g - d);
    ...
    pb.prototype = {
        ...
        colorizeItem: function (a, b) {
            var c = this.options, d = a.legendItem, e = a.legendLine, f = a.legendSymbol,
                ...
                h = b ? a.legendColor || a.color || "#CCC" : g, g = a.options && a.options.marker, i = {fill: h}, k;
            ...
            var b = this.chart,
                c = b.renderer, d = this.options, e = d.layout === "horizontal", f = this.symbolWidth,
                g = d.symbolPadding, h = this.itemStyle, i = this.itemHiddenStyle, k = this.padding,
                j = e ? o(d.itemDistance, 20) : 0, l = !d.rtl, m = d.width, n = d.itemMarginBottom || 0,
                p = this.itemMarginTop, u = this.initialItemX, q = a.legendItem,
                G = a.series && a.series.drawLegendSymbol ? a.series : a, x = G.options,
            ...
            var a = this, b = a.chart, c = b.renderer, d = a.group, e, f, g, h, i = a.box, k = a.options, j = a.padding,
                l = k.borderWidth, m = k.backgroundColor;
            ...
            var b = this, c = this.chart, d = c.renderer, e = this.options, f = e.y,
                ...
                i = this.clipRect, k = e.navigation, j = o(k.animation, !0), l = k.arrowSize || 12, m = this.nav,
                n = this.pages, p, u = this.allItems;
            ...
            var c = this.pages, d = c.length, e = this.currentPage + a, f = this.clipHeight,
                g = this.options.navigation, h = g.activeColor, g = g.inactiveColor, i = this.pager, k = this.padding;
            e > d && (e = d);
    ...
    Q = P.LegendSymbolMixin = {
        drawRectangle: function (a, b) {
            ...
            var e = this.chart.renderer, f = this.legendGroup,
                a = a.baseline - s(e.fontMetrics(a.options.itemStyle.fontSize).b * 0.3), g;
            if (b.lineWidth) {
    ...
    va.prototype = {
        ...
        adjustTickAmounts: function () {
            ...
            var b = this.axes, c = this.series, d = this.pointer, e = this.legend, f = this.isDirtyLegend, g, h,
                i = this.isDirtyBox, k = c.length, j = k, l = this.renderer, m = l.isHidden(), n = [];
            Ya(a, this);
            ...
            var b =
                    0, c = this.title, d = this.subtitle, e = this.options, f = e.title, e = e.subtitle,
        ...
        getChartSize: function () {
            ...
            var a = this.spacing, b, c = this.legend, d = this.margin, e = this.options.legend, f = o(e.margin, 20),
                g = e.x, h = e.y, i = e.align, k = e.verticalAlign, j = this.titleOffset;
            this.resetMargins();
            b = this.axisOffset;
            ...
            var b = this, c = b.options.chart, d = b.renderTo, e = c.width || nb(d, "width"),
                f = c.height || nb(d, "height"), c = a ? a.target : X, d = function () {
            ...
            var b = this.inverted, c = this.renderer, d = this.chartWidth, e = this.chartHeight, f = this.options.chart,
                g = this.spacing, h = this.clipOffset, i, k, j, l;
            ...
            var a = this.options.chart, b = this.renderer, c = this.chartWidth, d = this.chartHeight,
                ...
                i = a.borderWidth || 0, k = a.backgroundColor, j = a.plotBackgroundColor, l = a.plotBackgroundImage,
    ...
    ea = P.CenteredSeriesMixin =
        {
            getCenter: function () {
                var a = this.options, b = this.chart, c = 2 * (a.slicedOffset || 0), d, e = b.plotWidth - 2 * c,
                    f = b.plotHeight - 2 * c, b = a.center,
                    a = [o(b[0], "50%"), o(b[1], "50%"), a.size || "100%", a.innerSize || 0], g = z(e, f), h;
    ...
    za.prototype = {
        init: function (a, b, c) {
            ...
            for (var a = "graphic,dataLabel,dataLabelUpper,group,connector,shadowGroup".split(","), b,
                     c = 6; c--;)b = a[c], this[b] && (this[b] = this[b].destroy())
    ...
    K.prototype = {
        ...
        setData: function (a, b, c, d) {
            var e = this, f = e.points, g = f && f.length || 0, h, i = e.options, k = e.chart, j = null, l = e.xAxis,
                m = l && !!l.categories, n = e.tooltipPoints, p = i.turboThreshold, u = this.xData, s = this.yData, G =
        ...
        generatePoints: function () {
            var a = this.options.data, b = this.data, c, d = this.processedXData, e = this.processedYData,
                f = this.pointClass, g = d.length, h = this.cropStart || 0, i, k = this.hasGroupedData,
                j, l = [], m;
        ...
        translate: function () {
            ...
            for (var a = this.options, b = a.stacking, c = this.xAxis, d = c.categories, e = this.yAxis,
                     f = this.points, g = f.length, h = !!this.modifyValue, i = a.pointPlacement,
                     k = i === "between" || la(i), j = a.threshold, a = 0; a < g; a++) {
                var l = f[a], m = l.x, n = l.y, p = l.low,
        ...
        drawPoints: function () {
            ...
            var l = this.pointAttr[""], m, n = this.markerGroup,
        ...
        drawGraph: function () {
            var a = this, b = this.options, c = [["graph", b.lineColor || this.color]], d = b.lineWidth,
                e = b.dashStyle, f = b.linecap !== "square", g = this.getGraphPath(), h = b.negativeColor;
            h && c.push(["graphNeg", h]);
            q(c, function (c, h) {
                var j = c[0], l = a[j];
        ...
        render: function () {
            var a = this, b = a.chart, c, d = a.options, e = (c = d.animation) && !!a.animate &&
                    b.renderer.isSVG && o(c.duration, 500) || 0, f = a.visible ? "visible" : "hidden", g = d.zIndex,
    ...
    Rb.prototype = {
        destroy: function () {
            ...
            var c = this.axis, d = c.chart, e = d.inverted, f = this.isNegative,
                g = c.translate(c.usePercentage ? 100 : this.total, 0, 0, 0, 1), c = c.translate(0),
    ...
    K.prototype.setStackedPoints = function () {
        if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
            var a = this.processedXData, b = this.processedYData, c = [], d = b.length, e = this.options,
                f = e.threshold, g = e.stack, e = e.stacking, h = this.stackKey, i = "-" + h, k = this.negStacks,
                j = this.yAxis, l = j.stacks, m = j.oldStacks, n, p, u, o, q, x;
            for (o = 0; o < d; o++) {
                q = a[o];
                x = b[o];
                u = this.index + "," + o;
    ...
    K.prototype.setPercentStacks = function () {
        ...
        q([b, "-" + b], function (b) {
            var e;
            for (var f = d.length, g,
                     h; f--;)if (g = d[f], e = (h = c[b] && c[b][g]) && h.points[a.index + "," + f], g = e) h = h.total ? 100 / h.total : 0, g[0] = ha(g[0] * h), g[1] = ha(g[1] * h), a.stackedYData[f] = g[1]
        })
    };
    v(va.prototype, {
    ...
    v(K.prototype, {
        addPoint: function (a, b, c, d) {
            var e = this.options, f = this.data, g = this.graph, h = this.area, i = this.chart,
                k = this.xAxis && this.xAxis.names, j = g && g.shift || 0, l = e.data,
                m, n = this.xData;
            Ya(d, i);
    ...
    var ta = ga(K, {
        type: "area", getSegments: function () {
            var a = [], b = [], c = [], d = this.xAxis, e = this.yAxis, f = e.stacks[this.stackKey], g = {}, h, i,
                k = this.points, j = this.options.connectNulls, l, m, n;
    ...
    Aa = ga(K, {
        type: "column", pointAttrToOptions: {
            ...
            var c = z(M(c.transA) * (c.ordinalSlope || b.pointRange || c.closestPointRange || c.tickInterval || 1), c.len),
                k = c * b.groupPadding, j = (c - 2 * k) / i, l = b.pointWidth,
                b = t(l) ? (j - l) / 2 : j * b.pointPadding, l = o(l, j - 2 * b);
            ...
            var a = this, b = a.chart, c = a.options,
                d = a.borderWidth = o(c.borderWidth, a.activePointCount > 0.5 * a.xAxis.len ? 0 : 1), e = a.yAxis,
                f = a.translatedThreshold =
                    e.getThreshold(c.threshold), g = o(c.minPointLength, 5), c = a.getColumnMetrics(), h = c.width,
                i = a.barW = Va(w(h, 1 + 2 * d)), k = a.pointXOffset = c.offset, j = -(d % 2 ? 0.5 : 0),
                l = d % 2 ? 0.5 : 1;
            b.renderer.isVML && b.inverted && (l += 1);
            K.prototype.translate.apply(a);
            q(a.points, function (c) {
                var d = o(c.yBottom, f), p = z(w(-999 - d, c.plotY), e.len + 999 + d), u = c.plotX + k, q = i,
                    r = z(p, d), x;
                x = w(p, d) - r;
    ...
    J = {
        ...
        translate: function (a) {
            ...
            var b = 0, c = this.options, d = c.slicedOffset, e = d + c.borderWidth, f, g, h, i = c.startAngle || 0,
                ...
                i = (this.endAngleRad = ra / 180 * (o(c.endAngle, i + 360) - 90)) - k, j = this.points,
                l = c.dataLabels.distance, c = c.ignoreHiddenPoint, m, n = j.length, p;
    ...
    if (C.pie) C.pie.prototype.drawDataLabels = function () {
        var a = this, b = a.data, c, d = a.chart, e = a.options.dataLabels, f = o(e.connectorPadding,
            10), g = o(e.connectorWidth, 1), h = d.plotWidth, d = d.plotHeight, i, k, j = o(e.softConnector, !0),
            l = e.distance, m = a.center, n = m[2] / 2, p = m[1], u = l > 0, r, G, x, t, v = [[], []], y, z, A, B, D,
            U = [0, 0, 0, 0], I = function (a, b) {
                return b.y - a.y
            };
    ...
    if (C.column) C.column.prototype.alignDataLabel = function (a, b, c, d, e) {
        var f = this.chart, g = f.inverted, h = a.dlBox || a.shapeArgs,
            i = a.below || a.plotY > o(this.translatedThreshold, f.plotSizeY), k = o(c.inside, !!this.options.stacking);
        if (h && (d = y(h), g && (d = {
    ...
    var gb = P.TrackerMixin = {
        drawTrackerPoint: function () {
            ...
            var a = this, b = a.options, c = b.trackByArea, d = [].concat(c ? a.areaPath : a.graphPath), e = d.length,
                f = a.chart, g = f.pointer, h = f.renderer, i = f.options.tooltip.snap, k = a.tracker, j = b.cursor,
                l = j && {cursor: j}, j = a.singlePoints, m,
                n = function () {
    ...
    v(va.prototype, {
        showResetZoom: function () {
            ...
            q(b === "xy" ? [1, 0] : [1], function (b) {
                var d =
                        a[b ? "chartX" : "chartY"], h = c[b ? "xAxis" : "yAxis"][0], i = c[b ? "mouseDownX" : "mouseDownY"],
                    k = (h.pointRange || 0) / 2, j = h.getExtremes(), l = h.toValue(i - d, !0) + k,
        ...
        select: function (a, b) {
            ...
            var c = this.plotX, d = this.plotY, e = this.series, f = e.options.states,
                g = T[e.type].marker && e.options.marker, h = g &&
                    !g.enabled, i = g && g.states[a], k = i && i.enabled === !1, j = e.stateMarkerGraphic,
    ...
    O(va.prototype,
        "pan", function (a, b) {
            ...
            if (c.options.ordinal && c.series.length) {
                var f = this.mouseDownX, g = c.getExtremes(), h = g.dataMax, i = g.min, k = g.max, j = this.hoverPoints,
                    l = c.closestPointRange, f = (f - d) / (c.translationSlope * (c.ordinalSlope || l)),
                    m = {ordinalPositions: c.getExtendedPositions()}, l = c.lin2val, n = c.val2lin, p;
    ...
    var ba = K.prototype, J = Hb.prototype, hc = ba.processData, ic = ba.generatePoints, jc = ba.destroy,
        kc = J.tooltipHeaderFormatter, lc = {
    ...
    ba.groupData = function (a, b, c, d) {
        var e = this.data, f = this.options.data, g = [],
            h = [], i = a.length, k, j, l = !!b, m = [[], [], [], []], d = typeof d === "function" ? d : Na[d],
            n = this.pointArrayMap, p = n && n.length, o;
        ...
        for (; o <= i; o++) {
            ...
            if (n) {
                ...
                var q;
                for (j = 0; j < p; j++)if (q = k[n[j]], typeof q === "number") m[j].push(q); else if (q === null) m[j].hasNulls =
                    !0
    ...
    ba.processData = function () {
        ...
        if (hc.apply(this, arguments) !== !1 && d) {
            ...
            var f = this.processedXData, g = this.processedYData, h = a.plotSizeX, a = this.xAxis,
                i = a.options.ordinal, k = this.groupPixelWidth = a.getGroupPixelWidth && a.getGroupPixelWidth(),
                d = this.pointRange;
            if (k) {
                e = !0;
                this.points = null;
                var j = a.getExtremes(), d = j.min, j = j.max, i = i && a.getGroupIntervalFactor(d, j, this) || 1,
                    h = k * (j - d) / h * i,
                    k = a.getTimeTicks(a.normalizeTimeTickInterval(h, c.units || Xb), d, j, null, f, this.closestPointRange),
                    g = ba.groupData.apply(this, [f, g, k, c.approximation]), f = g[0], g = g[1];
                if (c.smoothed) {
                    c = f.length - 1;
    ...
    J = ga(C.column, {
        ...
        getAttribs: function () {
            ...
            var a = this.options, b = a.states, a = a.upColor || this.color, c = y(this.pointAttr),
                d = this.upColorProp;
            c[""][d] = a;
    ...
    yb.prototype = {
        drawHandle: function (a, b) {
            ...
            var e = this.chart, f = e.renderer, g, h,
                i, k, j = this.scrollbarGroup, l = this.navigatorGroup, m = this.scrollbar, l = this.xAxis,
                n = this.scrollbarTrack, p = this.scrollbarHeight, q = this.scrollbarEnabled, r = this.navigatorOptions,
                t = this.scrollbarOptions, x = t.minWidth, v = this.height, y = this.top, A = this.navigatorEnabled,
                B = r.outlineWidth, C = B / 2, F = 0, D = this.outlineHeight, I = t.barBorderRadius,
                H = t.barBorderWidth, E = y + C, J;
            if (!isNaN(a)) {
            ...
            a.mouseDownHandler = function (d) {
                var d = b.pointer.normalize(d), e = a.zoomedMin, f = a.zoomedMax, h = a.top, k = a.scrollbarHeight,
                    m = a.scrollerLeft, n = a.scrollerWidth, o = a.navigatorLeft, p = a.navigatorWidth,
                    q = a.scrollbarPad, r = a.range, s = d.chartX, t = d.chartY, d = b.xAxis[0], v, w = cb ? 10 : 7;
            ...
            var a =
                    this.chart.scroller, b = a.baseSeries, c = b.xAxis, d = c.getExtremes(), e = d.min, f = d.max,
                g = d.dataMin, d = d.dataMax, h = f - e, i, k, j, l, m, n = a.series;
            i = n.xData;
            var o = !!c.setExtremes;
    ...
    zb.prototype = {
        clickButton: function (a, b) {
            var c = this, d = c.selected, e = c.chart, f = c.buttons, g = c.buttonOptions[a], h = e.xAxis[0],
                i = e.scroller && e.scroller.getUnionExtremes() || h || {}, k = i.dataMin, j = i.dataMax, l,
                m = h && s(z(h.max, o(j, h.max))), n = new Date(m), p = g.type, u = g.count, i = g._range, t;
        ...
        updateButtonStates: function (a) {
            var b = this, c = this.chart, d = c.xAxis[0], e = c.scroller && c.scroller.getUnionExtremes() || d,
                f = e.dataMin, g = e.dataMax, h = b.selected, i = b.buttons;
            a && c.fixedRange !== s(d.max - d.min) && (i[h] && i[h].setState(0),
                b.setSelected(null));
            q(b.buttonOptions, function (a, c) {
                var e = a._range, m = e > g - f, n = e < d.minRange,
        ...
        drawInput: function (a) {
            var b = this, c = b.chart, d = c.renderer.style, e = c.renderer, f = c.options.rangeSelector, g = b.div,
                h = a === "min", i, k, j, l = this.inputGroup;
        ...
        render: function (a, b) {
            var c = this, d = c.chart, e = d.renderer, f = d.container, g = d.options,
                h = g.exporting && g.navigation && g.navigation.buttonOptions, i = g.rangeSelector, k = c.buttons,
                g = F.lang, j = c.div, j = c.inputGroup,
    ...
    L.prototype.toFixedRange = function (a, b, c, d) {
        var e = this.chart && this.chart.fixedRange, a = o(c, this.translate(a, !0)), b = o(d, this.translate(b, !0)),
            c = e && (b - a) / e;
    ...
    P.StockChart = function (a, b) {
        var c = a.series, d, e = o(a.navigator && a.navigator.enabled, !0) ? {startOnTick: !1, endOnTick: !1} : null,
            f = {marker: {enabled: !1, radius: 2}, states: {hover: {lineWidth: 2}}}, g = {shadow: !1, borderWidth: 0};
    ...
    L.prototype.getPlotLinePath = function (a, b, c, d, e) {
        var f = this, g = this.isLinked && !this.series ? this.linkedParent.series : this.series, h = f.chart,
            i = h.renderer, k = f.left, j = f.top, l, m, n, p, r = [], v, w;
    ...
    O(L.prototype, "drawCrosshair", function (a, b, c) {
        ...
        if (t(this.crosshair.label) && this.crosshair.label.enabled && t(c)) {
            var a = this.chart, f = this.options.crosshair.label, g = this.isXAxis ? "x" : "y", b = this.horiz,
                h = this.opposite, i = this.left, k = this.top, j = this.crossLabel, l, m, n = f.format, p = "";
